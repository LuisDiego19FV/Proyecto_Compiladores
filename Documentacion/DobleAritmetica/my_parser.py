...
class Parser():
    ...
    def Double(self):
        while(self.la.get_tok_type() == self._pt3 or self.la.get_tok_type() == self._number or self.la.get_tok_type() == self._decnumber or self.la.get_tok_type() == self._pt6):
            self.Stat()
    ...
    def Factor(self, result):
        ...
        if(self.la.get_tok_type() == self._pt3):
            self.Expect(self._pt3)
            sign = -1
        if(self.la.get_tok_type() == self._number or self.la.get_tok_type() == self._decnumber):
    ...
    def Number(self, result):
        ...
        elif(self.la.get_tok_type() == self._decnumber):
            self.Expect(self._decnumber)
        result = float(self.t.get_val())
        return(result)
